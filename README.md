...
#>      0.0095      1.2588 -435.5202    1.936
#>      0.0268      1.3121 -425.0740    1.816
#>      0.0000      1.1986 -426.7560    0.269
#>      0.0000      1.2457 -416.3099    1.965
#>      0.0673      1.3751 -946.4446    3.620
#>      0.0193      1.2775 -979.4971    2.159
#>      0.0076      1.2550 -657.9079    2.481
#>      0.0390      1.3047 -956.8907    1.924
#>      0.0000      1.1954 -649.1437    0.814
#>      0.0000      1.3012 -937.6804    1.953
#> 
#> =========================================================================
#>                AUTOMATED RESIDUAL DIAGNOSTIC LEADERBOARD                 
#> =========================================================================
...
<img src="man/figures/README-Fast but not express track-10.png" alt="" width="100%" />
    ...
    #> <bytecode: 0x9589eab68>
    #> <environment: 0x948e185b8>
    #> 
    #> $draw_diagnostics
...
#> 1                   0.8761                   0.9484    1.892      1.7693
#> 2                   0.8658                   0.9299   13.428      2.8946
#> 3                   0.8647                   0.9299   19.648      2.1659
#> 4                   0.8695                   0.9299    5.306      1.6825
#> 5                   0.8729                   0.9299    2.239      1.3146
