...
#' @importFrom graphics mtext pairs
...
for (i in 1:numresamples) {
  ...
  ensemble_elastic_cv <- cv.glmnet(ensemble_x, ensemble_y, alpha = 0.5)
  ...
  ensemble_lasso_cv <- cv.glmnet(ensemble_x, ensemble_y, alpha = 1)
  ...
  ensemble_ridge_cv <- cv.glmnet(ensemble_x, ensemble_y, alpha = 0)
...
summary_results <- data.frame(
  ...
  "Overfitting_min" = round(c(
    0, bag_rf_overfitting_range[1], bagging_overfitting_range[1], bayesglm_overfitting_range[1], bayesrnn_overfitting_range[1],
    boost_rf_overfitting_range[1], cubist_overfitting_range[1], earth_overfitting_range[1], min(elastic_overfitting_df$elastic_overfitting[2:nrow(elastic_overfitting_df)]), gam_overfitting_range[1], gb_overfitting_range[1],
    knn_overfitting_range[1], min(lasso_overfitting_df$lasso_overfitting[2:nrow(lasso_overfitting_df)]), linear_overfitting_range[1], neuralnet_overfitting_range[1],
    pls_overfitting_range[1], pcr_overfitting_range[1], rf_overfitting_range[1], min(ridge_overfitting_df$ridge_overfitting[2:nrow(ridge_overfitting_df)]),
    rpart_overfitting_range[1], svm_overfitting_range[1], tree_overfitting_range[1], xgb_overfitting_range[1],
    ensemble_bag_rf_overfitting_range[1], ensemble_bagging_overfitting_range[1], ensemble_elastic_overfitting_range[1], ensemble_gb_overfitting_range[1],
    ensemble_knn_overfitting_range[1], ensemble_lasso_overfitting_range[1], ensemble_linear_overfitting_range[1],
    ensemble_bayesglm_overfitting_range[1], ensemble_bayesrnn_overfitting_range[1], ensemble_boost_rf_overfitting_range[1], ensemble_cubist_overfitting_range[1],
    ensemble_earth_overfitting_range[1],
    ensemble_rf_overfitting_range[1], ensemble_ridge_overfitting_range[1], ensemble_rpart_overfitting_range[1],
    ensemble_svm_overfitting_range[1], ensemble_tree_overfitting_range[1], ensemble_xgb_overfitting_range[1]
  ), 4),
  ...
  "Overfitting_max" = round(c(
    0, bag_rf_overfitting_range[2], bagging_overfitting_range[2], bayesglm_overfitting_range[2], bayesrnn_overfitting_range[2],
    boost_rf_overfitting_range[2], cubist_overfitting_range[2], earth_overfitting_range[2], min(elastic_overfitting_df$elastic_overfitting[2:nrow(elastic_overfitting_df)]), gam_overfitting_range[2], gb_overfitting_range[2],
    knn_overfitting_range[2], min(lasso_overfitting_df$lasso_overfitting[2:nrow(lasso_overfitting_df)]), linear_overfitting_range[2], neuralnet_overfitting_range[2],
    pls_overfitting_range[2], pcr_overfitting_range[2], rf_overfitting_range[2], min(ridge_overfitting_df$ridge_overfitting[2:nrow(ridge_overfitting_df)]),
    rpart_overfitting_range[2], svm_overfitting_range[2], tree_overfitting_range[2], xgb_overfitting_range[2],
    ensemble_bag_rf_overfitting_range[2], ensemble_bagging_overfitting_range[2], ensemble_elastic_overfitting_range[2], ensemble_gb_overfitting_range[2],
    ensemble_knn_overfitting_range[2], ensemble_lasso_overfitting_range[2], ensemble_linear_overfitting_range[2],
    ensemble_bayesglm_overfitting_range[2], ensemble_bayesrnn_overfitting_range[2], ensemble_boost_rf_overfitting_range[2], ensemble_cubist_overfitting_range[2],
    ensemble_earth_overfitting_range[2],
    ensemble_rf_overfitting_range[2], ensemble_ridge_overfitting_range[2], ensemble_rpart_overfitting_range[2],
    ensemble_svm_overfitting_range[2], ensemble_tree_overfitting_range[2], ensemble_xgb_overfitting_range[2]
  ), 4),
  "Duration" = round(c(
...
bag_rf_qq <- ggplot(bag_rf_df, aes(sample = as.numeric(y_hat_bag_rf))) + ggplot2::stat_qq() +
...
bagging_qq <- ggplot(bagging_df, aes(sample = as.numeric(y_hat_bagging))) + ggplot2::stat_qq() +
...
bayesglm_qq <- ggplot(bayesglm_df, aes(sample = as.numeric(y_hat_bayesglm))) + ggplot2::stat_qq() +
...
bayesrnn_qq <- ggplot(bayesrnn_df, aes(sample = as.numeric(y_hat_bayesrnn))) + ggplot2::stat_qq() +
...
boost_rf_qq <- ggplot(boost_rf_df, aes(sample = as.numeric(y_hat_boost_rf))) + ggplot2::stat_qq() +
  labs(title = "Boost Random Forest model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
cubist_qq <- ggplot(cubist_df, aes(sample = as.numeric(y_hat_cubist))) + ggplot2::stat_qq() +
...
earth_qq <- ggplot(earth_df, aes(sample = as.numeric(y_hat_earth))) + ggplot2::stat_qq() +
...
elastic_qq <- ggplot(elastic_df, aes(sample = as.numeric(y_hat_elastic))) + ggplot2::stat_qq() +
  labs(title = "Elastic model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
gam_qq <- ggplot(gam_df, aes(sample = as.numeric(y_hat_gam))) + ggplot2::stat_qq() +
  labs(title = "Generalized Additive Model with splines: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
gb_qq <- ggplot(gb_df, aes(sample = as.numeric(y_hat_gb))) + ggplot2::stat_qq() +
  labs(title = "Gradient Boosted model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
knn_qq <- ggplot(knn_df, aes(sample = as.numeric(y_hat_knn))) + ggplot2::stat_qq() +
  labs(title = "KNN model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
lasso_qq <- ggplot(lasso_df, aes(sample = as.numeric(y_hat_lasso))) + ggplot2::stat_qq() +
  labs(title = "Lasso model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
linear_qq <- ggplot(linear_df, aes(sample = as.numeric(y_hat_linear))) + ggplot2::stat_qq() +
...
neuralnet_qq <- ggplot(neuralnet_df, aes(sample = as.numeric(y_hat_neuralnet))) + ggplot2::stat_qq() +
  labs(title = "Neuralnet model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
pls_qq <- ggplot(pls_df, aes(sample = as.numeric(y_hat_pls))) + ggplot2::stat_qq() +
  labs(title = "PLS model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
pcr_qq <- ggplot(pcr_df, aes(sample = as.numeric(y_hat_pcr))) + ggplot2::stat_qq() +
  labs(title = "PCR model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
rf_qq <- ggplot(rf_df, aes(sample = as.numeric(y_hat_rf))) + ggplot2::stat_qq() +
...
ridge_qq <- ggplot(ridge_df, aes(sample = as.numeric(y_hat_ridge))) + ggplot2::stat_qq() +
  labs(title = "Ridge model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
rpart_qq <- ggplot(rpart_df, aes(sample = as.numeric(y_hat_rpart))) + ggplot2::stat_qq() +
...
svm_qq <- ggplot(svm_df, aes(sample = as.numeric(y_hat_svm))) + ggplot2::stat_qq() +
...
tree_qq <- ggplot(tree_df, aes(sample = as.numeric(y_hat_tree))) + ggplot2::stat_qq() +
...
xgb_qq <- ggplot(xgb_df, aes(sample = as.numeric(y_hat_xgb))) + ggplot2::stat_qq() +
...
ensemble_bag_rf_qq <- ggplot(ensemble_bag_rf_df, aes(sample = as.numeric(ensemble_y_hat_bag_rf))) + ggplot2::stat_qq() +
...
ensemble_bagging_qq <- ggplot(ensemble_bagging_df, aes(sample = as.numeric(ensemble_y_hat_bagging))) + ggplot2::stat_qq() +
...
ensemble_bayesglm_qq <- ggplot(ensemble_bayesglm_df, aes(sample = as.numeric(ensemble_y_hat_bayesglm))) + ggplot2::stat_qq() +
  labs(title = "Ensemble BayesGLM model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_bayesrnn_qq <- ggplot(ensemble_bayesrnn_df, aes(sample = as.numeric(ensemble_y_hat_bayesrnn))) + ggplot2::stat_qq() +
  labs(title = "Ensemble BayesRNN model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_boost_rf_qq <- ggplot(ensemble_boost_rf_df, aes(sample = as.numeric(ensemble_y_hat_boost_rf))) + ggplot2::stat_qq() +
...
ensemble_cubist_qq <- ggplot(ensemble_cubist_df, aes(sample = as.numeric(ensemble_y_hat_cubist))) + ggplot2::stat_qq() +
...
ensemble_earth_qq <- ggplot(ensemble_earth_df, aes(sample = as.numeric(ensemble_y_hat_earth))) + ggplot2::stat_qq() +
...
ensemble_elastic_qq <- ggplot(ensemble_elastic_df, aes(sample = as.numeric(y_hat_ensemble_elastic))) + ggplot2::stat_qq() +
  labs(title = "Ensemble Elastic model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_gb_qq <- ggplot(ensemble_gb_df, aes(sample = as.numeric(ensemble_y_hat_gb))) + ggplot2::stat_qq() +
  labs(title = "Ensemble Gradient Boosted model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_knn_qq <- ggplot(ensemble_knn_df, aes(sample = as.numeric(ensemble_y_hat_knn))) + ggplot2::stat_qq() +
  labs(title = "Ensemble KNN model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_lasso_qq <- ggplot(ensemble_lasso_df, aes(sample = as.numeric(y_hat_ensemble_lasso))) + ggplot2::stat_qq() +
  labs(title = "Ensemble Lasso model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_linear_qq <- ggplot(ensemble_linear_df, aes(sample = as.numeric(ensemble_y_hat_linear))) + ggplot2::stat_qq() +
...
ensemble_rf_qq <- ggplot(ensemble_rf_df, aes(sample = as.numeric(ensemble_y_hat_rf))) + ggplot2::stat_qq() +
  labs(title = "Ensemble Random Forest model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_ridge_qq <- ggplot(ensemble_ridge_df, aes(sample = as.numeric(y_hat_ensemble_ridge))) + ggplot2::stat_qq() +
  labs(title = "Ensemble Ridge model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_rpart_qq <- ggplot(ensemble_rpart_df, aes(sample = as.numeric(ensemble_y_hat_rpart))) + ggplot2::stat_qq() +
  labs(title = "Ensemble RPart model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_svm_qq <- ggplot(ensemble_svm_df, aes(sample = as.numeric(ensemble_y_hat_svm))) + ggplot2::stat_qq() +
  labs(title = "Ensemble Support Vector Machines model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_tree_qq <- ggplot(ensemble_tree_df, aes(sample = as.numeric(ensemble_y_hat_tree))) + ggplot2::stat_qq() +
  labs(title = "Ensemble Tree model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
ensemble_xgb_qq <- ggplot(ensemble_xgb_df, aes(sample = as.numeric(ensemble_y_hat_xgb))) + ggplot2::stat_qq() +
  labs(title = "Ensemble XGBoost model: Q-Q plot") +
  ggplot2::stat_qq_line(color = "red")
...
bias_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, Mean_Bias), y = Mean_Bias)) +
  ggplot2::geom_col(width = 0.5)+
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, vjust = 1, hjust=1)) +
  ggplot2::labs(x = "Model", y = "Holdout bias", title = "Mean bias, closer to zero is better") +
  ggplot2::geom_text(aes(label = Mean_Bias), vjust = -0.5, hjust = -0.5, angle = 90) +
  ggplot2::ylim(min(summary_results$Mean_Bias), 1.5*max(summary_results$Mean_Bias))

MAE_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, Mean_MAE), y = Mean_MAE)) +
  ggplot2::geom_col(width = 0.5)+
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, vjust = 1, hjust=1)) +
  ggplot2::labs(x = "Model", y = "Holdout MAE", title = "Mean MAE, closer to zero is better") +
  ggplot2::geom_text(aes(label = Mean_Bias), vjust = -0.5, hjust = -0.5, angle = 90) +
...
MSE_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, Mean_MSE), y = Mean_MSE)) +
  ggplot2::geom_col(width = 0.5)+
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, vjust = 1, hjust=1)) +
  ggplot2::labs(x = "Model", y = "Holdout MSE", title = "Mean MSE, lower is better") +
  ggplot2::geom_text(aes(label = Mean_Bias), vjust = -0.5, hjust = -0.5, angle = 90)  +
...
SSE_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, Mean_SSE), y = Mean_SSE)) +
  ggplot2::geom_col(width = 0.5)+
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, vjust = 1, hjust=1)) +
  ggplot2::labs(x = "Model", y = "Holdout SSE", title = "Mean SSE, lower is better") +
  ggplot2::geom_text(aes(label = Mean_Bias), vjust = -0.5, hjust = -0.5, angle = 90) +
...
if (do_you_have_new_data == "Y") {
  ...
  new_earth <- predict(object = earth_train_fit, newdata = new_data)
  ...
  new_data_results <-
    data.frame(
      ...
      "Ensemble_Earth" = round(new(ensemble_earth), 4),
