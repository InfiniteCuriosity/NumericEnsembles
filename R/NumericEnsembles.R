...
Numeric <- function(data, colnum, numresamples,
  ...
  p_value_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, t_test_p.value_mean), y = t_test_p.value_mean)) +
    ...
    ggplot2::ylim(0, 1.5*max(summary_results$t_test_p.value_mean)) +
  ...
  overfitting_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, Overfitting_mean), y = Overfitting_mean)) +
    ...
    ggplot2::ylim(0, 1.5*max(summary_results$Overfitting_mean)) +
  ...
  bias_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, Bias), y = Bias)) +
    ...
    ggplot2::ylim(0, 1.5*max(summary_results$Bias)) +
  ...
  # Print count vs group (high_50 vs low_50)
  print(for (i in 1:ncol(summary)) {
    print(ggplot2::ggplot(summary, ggplot2::aes(x = summary[, c(i)])) +
            ggplot2::ggtitle(paste0("Count of ", colnames(summary)[i])) +
            ggplot2::xlab(colnames(summary)[i]) +
            ggplot2::stat_count() +
  ...
  # print target vs group (high_50 vs low_50)
  print(for (i in 1:(ncol(summary)-1)) {
    print(ggplot2::ggplot(summary, ggplot2::aes(x = summary[, i], y = summary[, ncol(summary)-1])) +
            ggplot2::ggtitle(paste0(colnames(newdf)[ncol(newdf)], " by ", colnames(summary)[i])) +
            ggplot2::xlab(colnames(summary)[i]) +
            ggplot2::ylab(colnames(newdf)[ncol(newdf)]) +
            ggplot2::geom_col(aes(x = summary[, i], y = summary[, ncol(summary)-1])) +
            ggplot2::facet_grid(~ group)
    )
  }
  )
