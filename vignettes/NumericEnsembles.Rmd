...
The Kaggle competition is here: <https://www.kaggle.com/competitions/uou-g03784-2022-spring/leaderboard>
...
The function uses set.seed, so the results are consistent. The value used for the seed in this example is 12345.

The lowest RMSE is 0.1269 ± 0.027, as this shows:

![Boston Housing, set.seed=12345](images/Boston_Housing_set_seed=12345.jpeg){width="948"}
...
|------------------|--------|----------------------|
| EnsembleEarth    | 0.1269 | 0.027                |
| EnsembleCubist   | 0.1365 | 0.0435               |
| BayesRNN         | 0.1385 | 0.0054               |
| EnsembleBayesGLM | 0.1801 | 0.0675               |
| EnsembleLasso    | 0.2217 | 0.0491               |
| EnsembleBayesRNN | 0.2344 | 0.1346               |

**Automatic summary plots**

The function automatically returns 25 plots, here is the predicted vs actual for the best model:

![EnsembleEarth predicted vs actual using set.seed = 12345](images/EnsembleEarth_actual_vs_pred.jpeg)
...
Lowest RMSE from the NumericEnsembles package: 0.1269
...
Calculate percentage change: from V~1~ = 2.09684 to V~2~ = 0.1269 
...
**In fact, the 22nd most accurate model from NumericEnsembles was very close to the #1 result from the Kaggle results.** (22nd most accurate NumericEnsembles result = 2.1636, best result in the Kaggle competition = 2.09684). This shows that NumericEnsembles had 21 models that were more accurate than the winning example in the Kaggle competition with 49 teams and 699 submissions!
