...
The lowest RMSE is 0.1206 ± 0.0131, as this shows:
...
|-----------------------------|--------|----------------------|
| EnsembleBayesRNN            | 0.1206 | 0.0131               |
| EnsembleBaggedRandomForest  | 0.2159 | 0.0187               |
| EnsembleBoostedRF           | 0.2159 | 0.0187               |
| EnsembleCubist              | 0.3923 | 0.1181               |
| EnsembleEarth               | 0.3966 | 0.1271               |
| Ensemble K-NearestNeighbors | 0.4397 | 0.0102               |

**Automatic summary plots**

The function automatically returns 25 plots, here is the predicted vs actual for the best model:

![Predicted vs actual for set.seed=12345](images/pred_vs_actual.jpeg)
...
![Accuracy barchart](images/Accuracy_barchart-01.jpeg)

<br><br>

![Mean bias by model](images/Bias.jpeg)

<br><br>

![Duration](images/Duration.jpeg)
