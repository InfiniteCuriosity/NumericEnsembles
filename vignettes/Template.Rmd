...
7.  Overfitting (Holdout RMSE / Train RMSE) barchart (measures reproducibility)

8.  Overfitting (Holdout RMSE / Train RMSE) by model and resample (choose fixed or free scales)

9.  Kolomogorov-Smirnov test barchart

10.  t-test bar chart

11. Train vs holdout by model and resample (choose fixed or free scales)
